...
$query = "Select * from staff where Email='$email'";
    ...
    if ($query_run && mysqli_num_rows($query_run) > 0) {
        ...
        // Update password
        $query = "update staff set Password='$code' where Email = '$email'";
        $query_run = mysqli_query($con, $query);
        ...
        try {
            ...
            $mail->Username = 'leekx-wm19@student.tarc.edu.my';                     //SMTP username
            $mail->Password = '001020011861';                               //SMTP password
