...
<html>
    ...
    <body>
      ...
      <form class="form" id="Register_Form" action="processDoctorSignup.php" method="post" enctype="multipart/form-data">
        <h1 class="login-title">Registration</h1>
        <input type="text" class="login-input" name="doctorId" placeholder="Doctor Id" required />
        <input type="text" class="login-input" name="doctorName" placeholder="Doctor Name" required/>
        ...
        <input type="text" class="login-input" name="Specialization" placeholder="Specialization" required/>
        ...
        <p class="link"><a href="LoginRegisterModule/LoginDoctor.php">Click to Login</a></p>
    </form>
    </body>
</html>
