...
include("../Database/db.php");
    ...
    $paymentQuery = "UPDATE servicecharges SET status = 'Paid', paymentTime = '$result' WHERE Payment_service_id = '$payment_id'";
...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="5;url=../Report/Health&Report.php">
    </head>
    <body>
        <div class="">
