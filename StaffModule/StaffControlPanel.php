  ...
  <input type="submit" name="searching">
   ...
   <?php
        ...
        . "document.getElementById('test').style.display = 'none'"
                . "</script>";
        $query = "Select * from  appointment Where date = '$src' || username = '$src' || appt_id = '$src'";
        $query = mysqli_query($con,$query);
            ...
            $query = "Select * ,DATEDIFF(`date`, CURDATE()) AS diff  from  appointment ORDER BY diff DESC";
            $query = mysqli_query($con,$query);
                     }
            }
  ...
  <hr />
        ...
        if($query){
            ...
            <form action="../StaffModule/StaffDltBooking.php" method="post">
             ...
             <form action="../StaffModule/StaffUptStatus.php" method="post">
                    <input type="hidden" name="appt_id" value="<?php echo $row['appt_id']?>">
